        ...
        <div className="bg-slate-800 rounded-lg shadow-md p-6 md:p-8 mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            ...
            <div className="mt-4 md:mt-0 flex flex-wrap gap-2">
              <Button 
                ...
                className="flex items-center text-sm border-primary text-primary hover:bg-slate-700 px-3 py-1.5 rounded-md"
              >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {matches.map((support, index) => (
              <div 
                key={support.id} 
                className="bg-slate-700 border border-slate-600 rounded-lg overflow-hidden hover:shadow-md transition-shadow duration-300"
              >
                ...
                <div className="p-4">
                  <p className="text-gray-200 text-sm mb-4">{support.description}</p>
                  {support.amount && (
